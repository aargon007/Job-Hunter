    ...
    return (
        <div className='flex mt-10 md:flex-row flex-col-reverse gap-20 items-center'>
            <div className='w-full space-y-6'>
                <h1 className='text-3xl font-bold tracking-widest'>Find Your <br /> <span className='bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500'>Dream Job</span> Now.</h1>

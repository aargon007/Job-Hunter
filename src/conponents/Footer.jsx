        ...
        <div className='bg-[#1A1919] px-5 md:px-28 py-10 text-white mt-10'>
            <div className='flex flex-col md:flex-row justify-between space-y-5 md:space-y-0'>
                <div className='space-y-3'>
                    <h1 className='text-2xl font-bold text-blue-500'>Job Hunter</h1>
                ...
                <div className='space-y-3'>
                    <h3 className='text-xl font-semibold text-blue-500'>Contact</h3>
            ...
            <div className='flex justify-between flex-col md:flex-row'>
                ...
                <p className='text-blue-500'>Powered by Job Hunter</p>
            </div>
        </div>
    );
};
